...
{
    /// <summary>
    /// A class that finds types needed by MyBlog by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into MyBlog.
        /// </returns>
        ...
        /// <summary>Gets or sets whether MyBlog should iterate assemblies in the app domain when loading MyBlog types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that MyBlog assemblies aren't investigated (e.g. by not including something like "^MyBlog|..." you may break core functionality.</remarks>
